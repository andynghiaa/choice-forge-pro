  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        "bg-card/80 backdrop-blur-xl border border-border/50 shadow-2xl shadow-primary/10",
        "rounded-2xl",
    ...
    >
      ...
      <DialogPrimitive.Close className="absolute right-4 top-4 z-20 rounded-lg p-1.5 bg-muted/50 opacity-70 ring-offset-background transition-all hover:opacity-100 hover:bg-muted focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:pointer-events-none">
        <X className="h-4 w-4" />
