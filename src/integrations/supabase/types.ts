  ...
  public: {
    Tables: {
      ...
      blockchain_records: {
        ...
        Relationships: [
          {
            foreignKeyName: "blockchain_records_winner_id_fkey"
            columns: ["winner_id"]
            isOneToOne: true
      ...
      candidates: {
        ...
        Relationships: [
          {
            foreignKeyName: "candidates_room_id_fkey"
            columns: ["room_id"]
            isOneToOne: false
      ...
      winners: {
        ...
        Relationships: [
          {
            foreignKeyName: "winners_candidate_id_fkey"
            columns: ["candidate_id"]
            isOneToOne: false
            referencedRelation: "candidates"
            referencedColumns: ["id"]
    ...
    Enums: {
      room_status: "draft" | "active" | "voting_ended" | "finalized"
    }
    CompositeTypes: {
      [_ in never]: never
    }
